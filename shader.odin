...
/*
    ...
    void vert_main()
    {
        gl_Position = mul(float4(pos, 1.0f), _19_transform);
        color = color0;
    }
...
vs_source_hlsl5 := [749]u8 {
    ...
    0x29,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x74,0x72,0x61,0x6e,0x73,0x66,0x6f,0x72,0x6d,
...
/*
    ...
    {
        main0_out out = {};
        out.gl_Position = _19.transform * float4(in.pos, 1.0);
        out.color = in.color0;
        return out;
    }
